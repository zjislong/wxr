...
%% enumerated types
-type 'msgID'() :: 'none' | 'c_get_player_id' | 's_get_player_id' | 'c_login' | 's_login' | 's_globle_goal' | 'c_heart' | 's_heart' | 'c_finish_cg' | 'c_finish_tip' | 'c_player_info' | 's_player_info' | 'c_buy_pi_fu' | 's_buy_pi_fu' | 'c_change_pi_fu' | 's_change_pi_fu' | 'c_goal_reward' | 's_goal_reward' | 'c_get_goal_reward' | 's_get_goal_reward' | 'c_single_game' | 's_single_game' | 'c_single_game_end' | 's_single_game_end' | 'c_single_game_tip' | 'c_rank_info' | 's_rank_info' | 'c_friend_battle_invite' | 's_friend_battle_invite' | 'c_match_battle' | 's_battle_start' | 'c_catch_mark' | 'c_miss_mark' | 'c_use_skill' | 's_use_skill' | 's_score_change' | 's_hp_change' | 's_battle_end' | 'c_battle_info' | 's_battle_info' | 'c_cancel_match'.
-export_type(['msgID'/0]).
...
-type c_cancel_match() :: #c_cancel_match{}.
...
-export_type(['c_change_pi_fu'/0, 'c_goal_reward'/0, 'c_player_info'/0, 's_get_player_id'/0, 'c_use_skill'/0, 'c_catch_mark'/0, 'c_heart'/0, 's_player_info'/0, 'c_cancel_match'/0, 'c_finish_tip'/0, 'c_battle_info'/0, 'c_rank_info'/0, 'c_login'/0, 'c_finish_cg'/0, 's_login'/0, 's_single_game_end'/0, 'c_friend_battle_invite'/0, 's_friend_battle_invite'/0, 's_goal_reward'/0, 's_heart'/0, 's_hp_change'/0, 's_single_game'/0, 'p_star_info'/0, 's_battle_info'/0, 's_use_skill'/0, 'p_rank'/0, 's_globle_goal'/0, 's_score_change'/0, 'c_single_game_tip'/0, 's_change_pi_fu'/0, 'c_miss_mark'/0, 'c_get_player_id'/0, 'c_single_game_end'/0, 'c_single_game'/0, 'c_match_battle'/0, 's_get_goal_reward'/0, 's_rank_info'/0, 's_battle_end'/0, 's_battle_start'/0, 's_buy_pi_fu'/0, 'c_get_goal_reward'/0, 'c_buy_pi_fu'/0]).

-spec encode_msg(#c_change_pi_fu{} | #c_goal_reward{} | #c_player_info{} | #s_get_player_id{} | #c_use_skill{} | #c_catch_mark{} | #c_heart{} | #s_player_info{} | #c_cancel_match{} | #c_finish_tip{} | #c_battle_info{} | #c_rank_info{} | #c_login{} | #c_finish_cg{} | #s_login{} | #s_single_game_end{} | #c_friend_battle_invite{} | #s_friend_battle_invite{} | #s_goal_reward{} | #s_heart{} | #s_hp_change{} | #s_single_game{} | #p_star_info{} | #s_battle_info{} | #s_use_skill{} | #p_rank{} | #s_globle_goal{} | #s_score_change{} | #c_single_game_tip{} | #s_change_pi_fu{} | #c_miss_mark{} | #c_get_player_id{} | #c_single_game_end{} | #c_single_game{} | #c_match_battle{} | #s_get_goal_reward{} | #s_rank_info{} | #s_battle_end{} | #s_battle_start{} | #s_buy_pi_fu{} | #c_get_goal_reward{} | #c_buy_pi_fu{}) -> binary().
...
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      ...
      #c_cancel_match{} ->
	  e_msg_c_cancel_match(Msg, TrUserData);
...
e_msg_c_cancel_match(_Msg, _TrUserData) -> <<>>.
...
e_msg_s_battle_info(#s_battle_info{status = F1,
				   ...
				   info = F5, match_second = F6, star = F7},
		    Bin, TrUserData) ->
    B1 = begin
	   TrF1 = id(F1, TrUserData),
	   e_varint(TrF1, <<Bin/binary, 8>>)
...
decode_msg_2_doit(c_cancel_match, Bin, TrUserData) ->
    d_msg_c_cancel_match(Bin, TrUserData);
...
d_msg_c_cancel_match(Bin, TrUserData) ->
    dfp_read_field_def_c_cancel_match(Bin, 0, 0,
				      TrUserData).

dfp_read_field_def_c_cancel_match(<<>>, 0, 0, _) ->
    #c_cancel_match{};
dfp_read_field_def_c_cancel_match(Other, Z1, Z2,
				  TrUserData) ->
    dg_read_field_def_c_cancel_match(Other, Z1, Z2,
				     TrUserData).

dg_read_field_def_c_cancel_match(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_c_cancel_match(Rest, N + 7,
				     X bsl N + Acc, TrUserData);
dg_read_field_def_c_cancel_match(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> skip_varint_c_cancel_match(Rest, 0, 0, TrUserData);
      1 -> skip_64_c_cancel_match(Rest, 0, 0, TrUserData);
      2 ->
	  skip_length_delimited_c_cancel_match(Rest, 0, 0,
					       TrUserData);
      3 ->
	  skip_group_c_cancel_match(Rest, Key bsr 3, 0,
				    TrUserData);
      5 -> skip_32_c_cancel_match(Rest, 0, 0, TrUserData)
    end;
dg_read_field_def_c_cancel_match(<<>>, 0, 0, _) ->
    #c_cancel_match{}.

skip_varint_c_cancel_match(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, TrUserData) ->
    skip_varint_c_cancel_match(Rest, Z1, Z2, TrUserData);
skip_varint_c_cancel_match(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, TrUserData) ->
    dfp_read_field_def_c_cancel_match(Rest, Z1, Z2,
				      TrUserData).

skip_length_delimited_c_cancel_match(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_c_cancel_match(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
skip_length_delimited_c_cancel_match(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_c_cancel_match(Rest2, 0, 0,
				      TrUserData).

skip_group_c_cancel_match(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_c_cancel_match(Rest, 0, Z2,
				      TrUserData).

skip_32_c_cancel_match(<<_:32, Rest/binary>>, Z1, Z2,
		       TrUserData) ->
    dfp_read_field_def_c_cancel_match(Rest, Z1, Z2,
				      TrUserData).

skip_64_c_cancel_match(<<_:64, Rest/binary>>, Z1, Z2,
		       TrUserData) ->
    dfp_read_field_def_c_cancel_match(Rest, Z1, Z2,
				      TrUserData).
...
dfp_read_field_def_s_battle_info(<<48, Rest/binary>>,
    ...
    d_field_s_battle_info_match_second(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
				       TrUserData);
dfp_read_field_def_s_battle_info(<<56, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				 F@_7, TrUserData) ->
    d_field_s_battle_info_star(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData);
dfp_read_field_def_s_battle_info(<<>>, 0, 0, F@_1, F@_2,
				 F@_3, F@_4, R1, F@_6, F@_7, TrUserData) ->
    #s_battle_info{status = F@_1, time = F@_2,
		   fight_count = F@_3, add_second = F@_4,
		   info = lists_reverse(R1, TrUserData),
		   match_second = F@_6, star = F@_7};
...
dg_read_field_def_s_battle_info(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_s_battle_info_match_second(Rest, 0, 0, F@_1,
					     ...
					     TrUserData);
      56 ->
	  d_field_s_battle_info_star(Rest, 0, 0, F@_1, F@_2, F@_3,
				     F@_4, F@_5, F@_6, F@_7, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
...
d_field_s_battle_info_star(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
			   TrUserData)
    when N < 57 ->
    d_field_s_battle_info_star(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
			       TrUserData);
d_field_s_battle_info_star(<<0:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, _,
			   TrUserData) ->
    {NewFValue, RestF} = {X bsl N + Acc, Rest},
    dfp_read_field_def_s_battle_info(RestF, 0, 0, F@_1,
...
merge_msgs(Prev, New, Opts)
    ...
    case Prev of
      ...
      #c_cancel_match{} ->
	  merge_msg_c_cancel_match(Prev, New, TrUserData);
      #c_finish_tip{} ->
...
merge_msg_c_cancel_match(_Prev, New, _TrUserData) ->
    New.
...
merge_msg_s_battle_info(#s_battle_info{info = PFinfo},
    ...
    #s_battle_info{status = NFstatus, time = NFtime,
		   ...
		   match_second = NFmatch_second, star = NFstar}.
...
verify_msg(Msg, Opts) ->
    ...
    case Msg of
      ...
      #c_cancel_match{} ->
	  v_msg_c_cancel_match(Msg, [c_cancel_match], TrUserData);
      #c_finish_tip{} ->
...
-dialyzer({nowarn_function,v_msg_c_cancel_match/3}).
v_msg_c_cancel_match(#c_cancel_match{}, _Path, _) -> ok.
...
get_msg_defs() ->
    [{{enum, msgID},
     ...
     {{msg, c_goal_reward}, []}, {{msg, c_player_info}, []},
     {{msg, s_get_player_id},
     ...
     {{msg, s_player_info},
      [#field{name = total_exp, fnum = 1, rnum = 2,
       ...
       #field{name = gold, fnum = 5, rnum = 6, type = uint32,
	      occurrence = required, opts = []}]},
     {{msg, c_cancel_match}, []}, {{msg, c_finish_tip}, []},
     {{msg, c_battle_info}, []},
     {{msg, c_rank_info},
     ...
     {{msg, s_battle_info},
      [#field{name = status, fnum = 1, rnum = 2,
       ...
       #field{name = match_second, fnum = 6, rnum = 7,
	      type = uint32, occurrence = required, opts = []},
       #field{name = star, fnum = 7, rnum = 8, type = uint32,
	      occurrence = required, opts = []}]},
     {{msg, s_use_skill},
      [#field{name = id, fnum = 1, rnum = 2, type = string,
	      occurrence = required, opts = []},
     ...
     {{msg, c_single_game_end},
      [#field{name = score, fnum = 1, rnum = 2, type = uint32,
       ...
       #field{name = gold, fnum = 3, rnum = 4, type = uint32,
	      occurrence = required, opts = []}]},
     {{msg, c_single_game}, []}, {{msg, c_match_battle}, []},
...
get_msg_names() ->
    [c_change_pi_fu, c_goal_reward, c_player_info,
     s_get_player_id, c_use_skill, c_catch_mark, c_heart,
     s_player_info, c_cancel_match, c_finish_tip,
     c_battle_info, c_rank_info, c_login, c_finish_cg,
     s_login, s_single_game_end, c_friend_battle_invite,
     s_friend_battle_invite, s_goal_reward, s_heart,
     s_hp_change, s_single_game, p_star_info, s_battle_info,
     s_use_skill, p_rank, s_globle_goal, s_score_change,
     c_single_game_tip, s_change_pi_fu, c_miss_mark,
     c_get_player_id, c_single_game_end, c_single_game,
     c_match_battle, s_get_goal_reward, s_rank_info,
     s_battle_end, s_battle_start, s_buy_pi_fu,
     c_get_goal_reward, c_buy_pi_fu].
...
enum_symbol_by_value_msgID(1414) -> c_cancel_match.
...
enum_value_by_symbol_msgID(c_cancel_match) -> 1414.
